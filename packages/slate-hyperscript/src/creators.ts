import { Element, Descendant, Node, Range, Text, Editor, createEditor as makeEditor } from '@solidoc/slate';
import {
  AnchorToken,
  FocusToken,
  Token,
...
export function createAnchor(tagName: string, attributes: { [key: string]: any }, children: any[]): AnchorToken {
...
export function createCursor(tagName: string, attributes: { [key: string]: any }, children: any[]): Token[] {
...
export function createFocus(tagName: string, attributes: { [key: string]: any }, children: any[]): FocusToken {
